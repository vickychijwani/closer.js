...
!function a(b,c,d){function e(g,h){if(!c[g]){if(!b[g]){var i="function"==typeof require&&require;if(!h&&i)return i(g,!0);if(f)return f(g,!0);throw new Error("Cannot find module '"+g+"'")}var j=c[g]={exports:{}};b[g][0].call(j.exports,function(a){var c=b[g][1][a];return e(c?c:a)},j,j.exports,a,b,c,d)}return c[g].exports}for(var f="function"==typeof require&&require,g=0;g<d.length;g++)e(d[g]);return e}({1:[function(a,b){(function(c){(function(){var d,e,f,g,h,i,j,k,l,m,n,o,p,q=[].slice;e={_$PLUS_:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(0,1/0,arguments.length),d.numbers(a),g.reduce(a,function(a,b){return a+b},0)},_$_:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(1,1/0,arguments.length),d.numbers(a),1===a.length&&a.unshift(0),g.reduce(a.slice(1),function(a,b){return a-b},a[0])},_$STAR_:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(0,1/0,arguments.length),d.numbers(a),g.reduce(a,function(a,b){return a*b},1)},_$SLASH_:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(1,1/0,arguments.length),d.numbers(a),1===a.length&&a.unshift(1),g.reduce(a.slice(1),function(a,b){return a/b},a[0])},inc:function(a){return d.arity(1,arguments.length),d.numbers(a),++a},dec:function(a){return d.arity(1,arguments.length),d.numbers(a),--a},max:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(1,1/0,arguments.length),d.numbers(a),g.max(a)},min:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(1,1/0,arguments.length),d.numbers(a),g.min(a)},quot:function(a,b){var c;return d.arity(2,arguments.length),d.numbers(arguments),c=a>0&&b>0||0>a&&0>b?1:-1,c*Math.floor(Math.abs(a/b))},rem:function(a,b){return d.arity(2,arguments.length),d.numbers(arguments),a%b},mod:function(a,b){var c;return d.arity(2,arguments.length),d.numbers(arguments),c=a%b,0===c||a>0&&b>0||0>a&&0>b?c:c+b},rand:function(){var a;return d.arity(0,1,arguments.length),a=1,1===arguments.length&&(d.numbers(arguments[0]),a=arguments[0]),Math.random()*a},rand_$_int:function(a){var b;return d.arity(1,arguments.length),b=e.rand(a),b>=0?Math.floor(b):Math.ceil(b)},_$EQ_:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(1,1/0,arguments.length),a=g.uniq(a),1===a.length?!0:f.equals.apply(null,a)},not_$EQ_:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(1,1/0,arguments.length),e.not(e._$EQ_.apply(null,a))},_$EQ__$EQ_:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(1,1/0,arguments.length),1===a.length?!0:(d.numbers(a),e._$EQ_.apply(null,a))},_$LT_:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(1,1/0,arguments.length),1===a.length?!0:(d.numbers(a),g.reduce(a,function(b,c,d){return b&&(d+1===a.length||c<a[d+1])},!0))},_$GT_:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(1,1/0,arguments.length),1===a.length?!0:(d.numbers(a),g.reduce(a,function(b,c,d){return b&&(d+1===a.length||c>a[d+1])},!0))},_$LT__$EQ_:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(1,1/0,arguments.length),1===a.length?!0:(d.numbers(a),g.reduce(a,function(b,c,d){return b&&(d+1===a.length||c<=a[d+1])},!0))},_$GT__$EQ_:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(1,1/0,arguments.length),1===a.length?!0:(d.numbers(a),g.reduce(a,function(b,c,d){return b&&(d+1===a.length||c>=a[d+1])},!0))},identical_$QMARK_:function(a,b){return d.arity(2,arguments.length),a===b},true_$QMARK_:function(a){return d.arity(1,arguments.length),a===!0},false_$QMARK_:function(a){return d.arity(1,arguments.length),a===!1},nil_$QMARK_:function(a){return d.arity(1,arguments.length),null===a},some_$QMARK_:function(a){return d.arity(1,arguments.length),null!==a},number_$QMARK_:function(a){return d.arity(1,arguments.length),"number"==typeof a},integer_$QMARK_:function(a){return d.arity(1,arguments.length),"number"==typeof a&&a%1===0},float_$QMARK_:function(a){return d.arity(1,arguments.length),"number"==typeof a&&a%1!==0},zero_$QMARK_:function(a){return d.arity(1,arguments.length),e._$EQ__$EQ_(a,0)},pos_$QMARK_:function(a){return d.arity(1,arguments.length),e._$GT_(a,0)},neg_$QMARK_:function(a){return d.arity(1,arguments.length),e._$LT_(a,0)},even_$QMARK_:function(a){return d.arity(1,arguments.length),d.integers(a),e.zero_$QMARK_(e.mod(a,2))},odd_$QMARK_:function(a){return e.not(e.even_$QMARK_(a))},contains_$QMARK_:function(a,b){return d.arity(2,arguments.length),d.associativeOrSet(a),f.has_key(a,b)},empty_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_empty(a)},keyword_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_keyword(a)},list_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_list(a)},seq_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_seq(a)},vector_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_vector(a)},map_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_map(a)},set_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_set(a)},coll_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_collection(a)},sequential_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_sequential(a)},associative_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_associative(a)},counted_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_counted(a)},seqable_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_seqable(a)},reversible_$QMARK_:function(a){return d.arity(1,arguments.length),f.is_reversible(a)},"boolean":function(a){return d.arity(1,arguments.length),a!==!1&&null!==a},not:function(a){return d.arity(1,arguments.length),!e.boolean(a)},str:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(0,1/0,arguments.length),g.reduce(a,function(a,b){return a+=e.nil_$QMARK_(b)?"":b.toString()},"")},println:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(0,1/0,arguments.length),console.log.apply(null,a)},keyword:function(a){return d.arity(1,arguments.length),f.keyword(a)},list:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(0,1/0,arguments.length),f.list.apply(null,a)},vector:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(0,1/0,arguments.length),f.vector.apply(null,a)},hash_$_map:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity_custom(arguments,function(a){return a.length%2!==0?"Expected even number of args, got "+a.length:void 0}),f.hash_map.apply(null,a)},hash_$_set:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(0,1/0,arguments.length),f.set(a)},count:function(a){return d.arity(1,arguments.length),d.seqable(a),f.count(a)},empty:function(a){var b;d.arity(1,arguments.length);try{return f.empty(a)}catch(c){return b=c,null}},not_$_empty:function(a){return d.arity(1,arguments.length),0===e.count(a)?null:a},get:function(a,b,c){return null==c&&(c=null),d.arity(2,3,arguments.length),f.get(a,b,c)},seq:function(a){return d.arity(1,arguments.length),d.seqable(a),f.seq(a)},first:function(a){return d.arity(1,arguments.length),f.first(a)},rest:function(a){return d.arity(1,arguments.length),f.rest(a)},next:function(a){var b;return d.arity(1,arguments.length),b=e.rest(a),e.empty_$QMARK_(b)?null:b},last:function(a){return d.arity(1,arguments.length),f.last(a)},nth:function(a,b,c){var e,h;if(d.arity(2,3,arguments.length),d.sequential(a),d.numbers(b),null===a)return void 0!==c?c:null;if(g.isString(a)&&b>=a.length&&void 0===c)throw h=new Error("Index out of bounds"),h.name="IndexOutOfBoundsError",h;try{return void 0!==c?f.nth(a,b,c):f.nth(a,b)}catch(i){throw e=i,/^No item/.test(e.message)||/^Index out of bounds/.test(e.message)?(h=new Error("Index out of bounds"),h.name="IndexOutOfBoundsError",h):e}},peek:function(a){return d.arity(1,arguments.length),d.stack(a),f.peek(a)},pop:function(a){return d.arity(1,arguments.length),d.stack(a),f.pop(a)},cons:function(a,b){return d.arity(2,arguments.length),f.cons(a,b)},conj:function(){var a,b;if(a=arguments[0],b=2<=arguments.length?q.call(arguments,1):[],d.arity(2,1/0,arguments.length),e.map_$QMARK_(a)&&g.any(b,function(a){return e.vector_$QMARK_(a)&&2!==e.count(a)}))throw new TypeError("vector args to conjoin to a map must be pairs");return f.conj.apply(null,g.flatten([a,b]))},disj:function(){var a,b;return b=arguments[0],a=2<=arguments.length?q.call(arguments,1):[],d.arity(1,1/0,arguments.length),d.type_custom(function(){return e.set_$QMARK_(b)?void 0:""+b+" is not a set"}),void 0===a&&(a=[]),e.apply(f.disj,b,a)},into:function(a,b){return d.arity(2,arguments.length),null===a&&null===b?null:f.reduce(e.conj,a,b)},concat:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(0,1/0,arguments.length),d.seqable.apply(null,a),f.concat.apply(null,a)},flatten:function(a){return d.arity(1,arguments.length),f.flatten(a)},reverse:function(a){return d.arity(1,arguments.length),d.seqable(a),f.reverse(a)},assoc:function(){var a,b;return b=arguments[0],a=2<=arguments.length?q.call(arguments,1):[],d.arity_custom(arguments,function(a){return a.length<3||a.length%2===0?"Expected odd number of args (at least 3), got "+a.length:void 0}),f.assoc.apply(null,g.flatten([b,a]))},dissoc:function(){var a,b;return b=arguments[0],a=2<=arguments.length?q.call(arguments,1):[],d.arity(1,1/0,arguments.length),0===a.length?b:f.dissoc.apply(null,g.flatten([b,a]))},keys:function(a){return d.arity(1,arguments.length),d.map(a),f.keys(a)},vals:function(a){return d.arity(1,arguments.length),d.map(a),f.vals(a)},key:function(a){return d.arity(1,arguments.length),d.type_custom(function(){return e.vector_$QMARK_(a)&&2===e.count(a)?void 0:""+a+" is not a valid map entry"}),e.first(a)},val:function(a){return d.arity(1,arguments.length),d.type_custom(function(){return e.vector_$QMARK_(a)&&2===e.count(a)?void 0:""+a+" is not a valid map entry"}),e.last(a)},find:function(a,b){return d.arity(2,arguments.length),d.associative(a),f.find(a,b)},range:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(0,3,arguments.length),d.numbers(a),f.range.apply(null,a)},identity:function(a){return d.arity(1,arguments.length),a},apply:function(){var a,b,c,f,g,h,i,j;for(b=arguments[0],a=2<=arguments.length?q.call(arguments,1):[],d.arity(2,1/0,arguments.length),f=a[a.length-1],h=a.slice(0,a.length-1),d["function"](b),d.seqable(f),g=e.seq(f),c=i=0,j=e.count(g);j>=0?j>i:i>j;c=j>=0?++i:--i)h.push(e.nth(g,c));return b.apply(null,h)},map:function(){var a,b;return b=arguments[0],a=2<=arguments.length?q.call(arguments,1):[],d.arity(2,1/0,arguments.length),d["function"](b),f.map.apply(null,arguments)},mapcat:function(){var a,b;return b=arguments[0],a=2<=arguments.length?q.call(arguments,1):[],d.arity(2,1/0,arguments.length),d["function"](b),f.mapcat.apply(null,arguments)},filter:function(a,b){return d.arity(2,arguments.length),d["function"](a),f.filter(a,b)},remove:function(a,b){return d.arity(2,arguments.length),d["function"](a),f.remove(a,b)},reduce:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(2,3,arguments.length),d["function"](a[0]),f.reduce.apply(null,a)},reduce_$_kv:function(a,b,c){return d.arity(3,arguments.length),d["function"](a),f.reduce_kv(a,b,c)},take:function(a,b){return d.arity(2,arguments.length),d.numbers(a),d.seqable(b),f.take(a,b)},drop:function(a,b){return d.arity(2,arguments.length),d.numbers(a),d.seqable(b),f.drop(a,b)},some:function(a,b){return d.arity(2,arguments.length),d["function"](a),d.seqable(b),f.some(a,b)},every_$QMARK_:function(a,b){return d.arity(2,arguments.length),d["function"](a),d.seqable(b),f.every(a,b)},sort:function(){return d.arity(1,2,arguments.length),1===arguments.length?d.seqable(arguments[0]):(d["function"](arguments[0]),d.seqable(arguments[1])),f.sort.apply(null,arguments)},sort_$_by:function(){return d.arity(2,3,arguments.length),2===arguments.length?(d["function"](arguments[0]),d.seqable(arguments[1])):(d["function"](arguments[0],arguments[1]),d.seqable(arguments[2])),f.sort_by.apply(null,arguments)},partition:function(){var a,b,c,e;switch(d.arity(2,4,arguments.length),arguments.length){case 2:b=arguments[0],a=arguments[1];break;case 3:b=arguments[0],e=arguments[1],a=arguments[2],d.numbers(e);break;case 4:b=arguments[0],e=arguments[1],c=arguments[2],a=arguments[3],d.numbers(e),d.seqable(c)}return d.numbers(b),d.seqable(a),f.partition.apply(null,arguments)},partition_$_by:function(a,b){return d.arity(2,arguments.length),d["function"](a),d.seqable(b),f.partition_by(a,b)},group_$_by:function(a,b){return d.arity(2,arguments.length),d["function"](a),d.seqable(b),f.group_by(a,b)},zipmap:function(a,b){return d.arity(2,arguments.length),d.seqable(a,b),f.zipmap(a,b)},iterate:function(a,b){return d.arity(2,arguments.length),d["function"](a),f.iterate(a,b)},constantly:function(a){return d.arity(1,arguments.length),f.constantly(a)},repeat:function(){return d.arity(1,2,arguments.length),2===arguments.length&&d.numbers(arguments[0]),f.repeat.apply(null,arguments)},repeatedly:function(){var a,b;return d.arity(1,2,arguments.length),1===arguments.length?a=arguments[0]:(b=arguments[0],a=arguments[1]),"undefined"!=typeof b&&d.numbers(b),d["function"](a),f.repeatedly.apply(null,arguments)},comp:function(){var a;return a=1<=arguments.length?q.call(arguments,0):[],d.arity(0,1/0,arguments.length),d["function"].apply(null,a),f.comp.apply(null,a)},partial:function(){var a,b;return b=arguments[0],a=2<=arguments.length?q.call(arguments,1):[],d.arity(1,1/0,arguments.length),d["function"](b),f.partial.apply(null,arguments)}},b.exports=e,g=null!=(h=null!=(i=null!=(j="undefined"!=typeof window&&null!==window?window._:void 0)?j:"undefined"!=typeof self&&null!==self?self._:void 0)?i:"undefined"!=typeof c&&null!==c?c._:void 0)?h:a("lodash-node"),f=null!=(k=null!=(l=null!=(m="undefined"!=typeof window&&null!==window?window.mori:void 0)?m:"undefined"!=typeof self&&null!==self?self.mori:void 0)?l:"undefined"!=typeof c&&null!==c?c.mori:void 0)?k:a("mori"),d=null!=(n=null!=(o=null!=(p="undefined"!=typeof window&&null!==window?window.assertions:void 0)?p:"undefined"!=typeof self&&null!==self?self.assertions:void 0)?o:"undefined"!=typeof c&&null!==c?c.assertions:void 0)?n:a("./assertions"),"undefined"!=typeof self&&null!==self&&(self.closerCore=e),"undefined"!=typeof window&&null!==window&&(window.closerCore=e)}).call(this)}).call(this,"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}]},{},[1]);